...
export const mockProfile: Profile = {
  ...
  email: 'shanmugapriyan.dev@gmail.com',
  phone: '+91 98765 43210',
  location: 'Tamil Nadu, India',
  whatsapp_url: 'https://wa.me/919876543210',
  calendar_url: 'https://calendly.com/shanmugapriyan',
  github_username: 'shanmugapriyan-dev',
  leetcode_username: 'shanmugapriyan_leetcode',
  updated_at: '2026-06-26T22:00:00Z',
};

export const mockSocialLinks: SocialLink[] = [
  { id: '1', platform: 'GitHub', url: 'https://github.com/shanmugapriyan-dev', icon: 'github' },
  { id: '2', platform: 'LinkedIn', url: 'https://linkedin.com/in/shanmugapriyan', icon: 'linkedin' },
  ...
  { id: '5', platform: 'Email', url: 'mailto:shanmugapriyan.dev@gmail.com', icon: 'mail' },
];
...
export const mockProjects: Project[] = [
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/ai-disease-analyzer',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/fake-news-detector',
  ...
  },
  {
    ...
    status: 'Active',
    github_url: 'https://github.com/shanmugapriyan-dev/powerbi-dashboards',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/cloud-kitchen',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/smart-attendance',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/career-guidance-ai',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/queue-system',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/blood-network',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/mentor-portal',
  ...
  },
  {
    ...
    status: 'Completed',
    github_url: 'https://github.com/shanmugapriyan-dev/emotion-analyzer',
...
export const mockCertificates: Certificate[] = [
  {
    ...
    credential_id: 'ML-STAN-99238',
    verification_url: 'https://coursera.org/verify/mock',
    thumbnail_url: '/images/certificates/ml-stanford.jpg',
    issue_date: '2024-07-15',
    description: 'Core concepts in supervised learning, neural networks, decision trees, and unsupervised reinforcement systems.',
    category: 'AI & Machine Learning',
    views: 310,
  },
  {
    ...
    credential_id: 'AWS-ASA-88123',
    verification_url: 'https://aws.amazon.com/verification',
    thumbnail_url: '/images/certificates/aws-architect.jpg',
    issue_date: '2024-04-10',
    description: 'Designing distributed resilient applications on the AWS ecosystem (EC2, S3, RDS, DynamoDB, VPC).',
  ...
  },
  {
    ...
    issuer: 'Microsoft',
    credential_id: 'MS-PL300-47120',
    verification_url: 'https://learn.microsoft.com/credentials',
    thumbnail_url: '/images/certificates/ms-powerbi.jpg',
    issue_date: '2023-12-05',
    description: 'Preparing database assets, cleaning schemas, mapping relations, DAX calculations, and sharing reports.',
    category: 'Power BI',
    views: 412,
  },
  {
    ...
    issuer: 'IBM',
    credential_id: 'IBM-DS-77491',
    verification_url: 'https://credly.com/verify/mock',
    thumbnail_url: '/images/certificates/ibm-data-science.jpg',
    issue_date: '2023-08-22',
    description: 'Python queries, database structures, exploratory statistical modeling, and machine learning models.',
